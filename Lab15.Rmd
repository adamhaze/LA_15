...
First and foremost, our team has discovered that the mean expenditure used on instruction for education has been steadily increasing over the years. This means that on average, states nationwide have slowly been spending more money on teachers and other instructors, which in turn, has lead to an increase in student enrollment (which was expected). This information can be useful to the Secretary of Education because the more we pay/spend on teachers, the more students are expected to be enrolled in school.
