...
####Comments: 
The graph shown, displays the changes in the number of student enrolled in school in the state of California. The trend shows how the number of students, who utilize students services, who are enrolled in the school. The color, suggests how the percantage of the total number of enrolled students is changed and 
